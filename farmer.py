...
if foundFile:
    ...
    if not os.path.exists(f"{workingDir}\{selectedExtension}_farmer.{selectedExtension}"):
        try:
            ...
            print("Each file has ~200,000 lines of code. This means it will keep running (minimum ~30 hours) until you do a KeyboardInterrupt (press Control-C on console)")
            sleep(10)
            try:
